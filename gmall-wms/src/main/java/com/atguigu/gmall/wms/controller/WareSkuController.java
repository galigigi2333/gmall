...
public class WareSkuController {
     ...
     */
    @GetMapping("{skuId}")
    public Resp<List<WareSkuEntity>> queryById (@PathVariable("skuId") Long skuId){

        List<WareSkuEntity> waresku = wareSkuService.list(new QueryWrapper<WareSkuEntity>().eq("sku_id", skuId));
